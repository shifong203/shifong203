...
namespace Vision2.vision.HalconRunFile.Controls
{
    ...
    partial class UserCtrlThreshold : UserControl
    {
        /// <summary>
        /// 初始化
        /// </summary>
        public UserCtrlThreshold()
        {
            InitializeComponent();
        ...
        public void SetData(Threshold_Min_Max threshold_Min_,HObject images)
        {
            threshold_Min_Max = threshold_Min_;
            try
            {
