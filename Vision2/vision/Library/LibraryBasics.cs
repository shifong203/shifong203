...
namespace Vision2.vision.Library
{
    ...
    {
        public static string PathStr = ErosProjcetDLL.Project.ProjectINI.ProjectPathRun + "\\Library\\Vision\\" + Project.formula.Product.ProductionName + "\\";

        public static string RunPath = ErosProjcetDLL.Project.ProjectINI.ProjectPathRun + "\\Library\\Vision\\";
