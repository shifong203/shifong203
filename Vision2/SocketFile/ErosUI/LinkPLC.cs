...
namespace ErosSocket.ErosUI
{
    public class LinkPLC
    {
        ...
        //[TypeConverter(typeof(ValuIDConverter)), CategoryAttribute("变量设置"), DisplayName("变量地址")]
        //public string ValuIDs
        //{
        //    get { return valuIDs; }
        //    set
        //    {
        ...
        //        {
        //            var dicSort = from objDic in ErosSocket.ErosConLink.StaticCon.SocketClint[DefaultFileName].KeysValues.DictionaryValueD
        //                          where objDic.Value.AddressID.ToString() == ValuID
