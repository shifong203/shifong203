...
namespace ErosSocket.ErosConLink
{
    public class S71200 : ModbusTCPClint
    {
        ...
        UClass.ErosValues.ErosValueD[] erosValueDs;
        UClass.ErosValues.ErosValueD[] erosValueDsT;
        List<string> addStat;
        ...
        bool IDGetValue(string addressID, string type, string length, out dynamic value, out string err)
        {
        ...
        dynamic GetByteValue(byte[] buffre, string typeName, int str, int lengt)
        {
            dynamic value = null;
            switch (typeName)
            {
