    ...
    public partial class SocketConnectForm : Form
    {
        ...
        private string loadDate()
        {
            try
            {
                ...
                //if (File.Exists(Vision2.ErosProjcetDLL.Project.ProjectINI.In.ProjectPathRun + "\\" + DicSocket.Instance.FileName + "\\XMLSocket.xml"))
                //{
                //    doc.Load(Vision2.ErosProjcetDLL.Project.ProjectINI.In.ProjectPathRun + "\\" + DicSocket.Instance.FileName + "\\XMLSocket.xml");
                //    //获得根节点
        ...
        {
            if (!StaticCon.WriteSocketXML(dataGridView1, Vision2.ErosProjcetDLL.Project.ProjectINI.In.ProjectPathRun + "\\" + DicSocket.Instance.FileName + "\\XMLSocket.xml"))
            {
