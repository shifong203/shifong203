...
namespace ErosSocket.DebugPLC
{
    ...
    {
        TreeNode treeNodeAx = new TreeNode() { Text = "轴集合", Name = "轴集合" };
        TreeNode treeNodeCyl = new TreeNode() { Text = "气缸集合", Name = "气缸集合" };
        TreeNode treeNodeAxisP = new TreeNode() { Text = "轴组合", Name = "轴组合" };
        TreeNode treeNodeRobotS = new TreeNode() { Text = "Robot", Name = "Robot" };
        TreeNode treeNodeIO = new TreeNode() { Text = "IO集合", Name = "IO集合" };
        TreeNode treeNodePrun = new TreeNode() { Text = "轨迹文件", Name = "轨迹文件" };
        //TreeNode treeNodeEnum = new TreeNode() { Text = "枚举集合", Name = "枚举集合" };

        TreeNode treeNodeC154 = new TreeNode() { Text = "板卡集合", Name = "板卡集合" };
