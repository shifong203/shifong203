...
namespace ErosSocket.ErosConLink
{
    public class 三菱MC : ModbusTCPClint
    {
        ...
        //public override bool SetValues(string valueKey, string value, out string errStr)
        //{
        //    try
        //    {
        //        errStr = "";
        //        if (!this.KeysValues.DictionaryValueD.ContainsKey(valueKey))
        //        {
        //            errStr += "Err:键:" + valueKey + "不存在!";
        //            return false;
        //        }
        //        Type d = null;
        //        if (this.KeysValues.DictionaryValueD[valueKey]._Type != "")
        //        {
        //            d = Type.GetType("System." + this.KeysValues.DictionaryValueD[valueKey]._Type, true, false);
        //        }
        //        else {
        //            errStr += "Err:键类型错误:" + this.KeysValues.DictionaryValueD[valueKey]._Type + "!";
        //            return false;
        //        };
        //        this.KeysValues.DictionaryValueD[valueKey].Value = Convert.ChangeType(value, d);
        //        this.SetData( this.KeysValues.DictionaryValueD[valueKey].District,this.KeysValues.DictionaryValueD[valueKey].AddressID,
        //                    1, Convert.ChangeType(value, d), out errStr);
        //        return true;
        //    }
        //    catch (Exception ex)
        //    {
